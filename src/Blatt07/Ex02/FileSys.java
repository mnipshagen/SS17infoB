...
import static Blatt07.Ex02.FileVisitorResult.CONTINUE;
import static Blatt07.Ex02.FileVisitorResult.STOP;
        ...
        implements Visitable<File>
{
     ...
     * @throws IOException if directory could not be created
     */
    public File addDirectory(File parent, String name)
            throws IOException
    {
        isInRoot(parent);
        if (!root.exists())
     ...
     * @throws IOException if file could not be created
     */
    public File addFile(File parent, String name)
            throws IOException
    {
        isInRoot(parent);
        if (!root.exists())
