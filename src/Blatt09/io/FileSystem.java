 ...
 * {@link Blatt09.io.FileVisitor} by using the {@link #accept(Blatt09.io.FileVisitor)} method.
 *
 * @author Mathias Meninghaus (mathias.menninghaus@uos.de)
 * @see Blatt09.io.FileVisitor
 * @see FileVisitResult
 */
public class FileSystem
{
     ...
     *
     * @param rootPath the root element
     * @throws IllegalArgumentException if <code>rootPath</code> does not exist
     */
     ...
     * {@link Blatt09.io.FileVisitor#visitFile(File)} for every file in every directory of
     * this FileSystem. Also calls {@link Blatt09.io.FileVisitor#preVisitDirectory(File)}
     * before entering a directory and
     * {@link Blatt09.io.FileVisitor#postVisitDirectory(File)} after leaving a fully read
     ...
     * {@link Blatt09.io.FileVisitor#preVisitDirectory(File)} method.
     *
     * @param v the Visitor that shall see all elements in this FileSystem.
     */
