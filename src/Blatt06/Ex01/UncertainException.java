...
public class UncertainException
{
    ...
    public int uncertain2()
    {
        ...
        { // infinite loop
            ...
            { // hence we don't go here
                i++;
            }
            finally
            { // even though the break we go here
                i++; // i = 1
    ...
    public int uncertain3()
    {
        do
        {
            ...
            { // guaranteed to be entered
                i++; // i = 1
                continue; // jump to the loop footer (condition)
            }
            finally
            { // but first do the stuff in here..
                i++; // i = 2
            }
    ...
    public int uncertain4()
    {
        ...
        { // but does go here before return
            i++; // i = 1
        }
    ...
    public int uncertain10()
    {
        ...
        { // hence: unhandled exception compiler error
        }
        catch (IOException ignored)
        {
        } // had to be added (alternatively throws IOException)
