...
public class Heap<E> implements Serializable{
   ...
   public Heap(Comparator<? super E> comparator) {
    ...
    public void serialize(String filename){
        ...
        try {
            ...
            oos.writeObject(filledHeap);

            // serialize the comparator
    ...
    public static Heap deserialize(String filename){
        ...
        try {
            ...
            Object[] old_heap = (Object[]) ois.readObject();
            int old_size = old_heap.length;

            // Secondly, reload the comparator
            Comparator old_comparator = (Comparator) ois.readObject();

            // Build a Heap object, fill with the old data, set old size and return it
            Heap new_heap = new Heap(old_comparator);
            new_heap.heap = old_heap;
            new_heap.size = old_size;
            return new_heap;
    ...
    * {@link java.lang.Comparable}. Throws a <code>NullPointerException</code>
